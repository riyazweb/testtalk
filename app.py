...
from src.utils.feautures import speak
                    ...
                    with gr.TabItem('Upload or Generating from TTS'):
                        ...
                        with gr.Column(variant='panel'):
                            input_text = gr.Textbox(label="Generating audio from text", lines=5,
                                                    placeholder="Alternatively, you can generate the audio from text using @Coqui.ai TTS.")
                            tts = gr.Button(
                            ...
                            tts.click(fn=speak_text, outputs=["data.wav"])
